    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="mb-3 row justify-content-center p-4">
              <div class="col-8">
                  <img src="https://ces.southernleytestateu.edu.ph/images/logo/logo.png" height="100" app-brand-logoalt="">
              </div>
          </div>
                    ...
                    @case(1)
                        <li class="menu-item">
                          <a href="{{ route('tasksIndex') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-crown"></i>
                            <div data-i18n="Boxicons">Create Tasks</div>
                          </a>
                        </li>
                        <li class="menu-item">
                          <a href="{{ route('tasksAssign') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-crown"></i>
                            <div data-i18n="Boxicons">Assign Task</div>
                          </a>
                        </li>
                        @break
                    @default
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                    <h5 class="mt-2"><strong>Task Manangement System</strong></h5>
                </div>
              </div>
              <!-- /Search -->
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            ...
                            <small class="text-muted">{{ config('const.role.'.Auth::user()->role) }}</small>
                          </div>
                        </div>
                      </a>
                    </li>
